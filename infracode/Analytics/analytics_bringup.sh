...
flintrock --debug launch GRP5$CLUSTER_NAME --num-slaves $NUM_CHILD --spark-version 3.0.1 --hdfs-version 3.2.1 --ec2-key-name Grp5cluster_$NUM_CHILD --ec2-identity-file Grp5cluster_$NUM_CHILD.pem --ec2-ami ami-04d29b6f966df1537 --ec2-instance-type t2.medium --ec2-user ec2-user --install-hdfs --install-spark
